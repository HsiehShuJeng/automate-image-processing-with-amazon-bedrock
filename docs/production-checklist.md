...
## Deployment Steps
1. `yarn build`
2. `node scripts/deploy.js prod`
3. Monitor CloudFormation stack events for all component stacks.
4. Tag release in source control after successful deployment.
